...
<head><meta http-equiv="content-type" content="application/xhtml+xml; charset=UTF-8" /><link href="App_Themes/fav-logo.ico" rel="shortcut icon" type="image/x-icon" /><link href="App_Themes/design.css" rel="stylesheet" type="text/css" /><link href="App_Themes/index.css" rel="stylesheet" type="text/css" /><link href="App_Themes/print.css" rel="stylesheet" type="text/css" media="print" /><title>
  ...
  <style>
    ...
    #menu a {
      margin: 0 10px; /* Adjust the margin value to increase or decrease the space between links */
    }
  </style>
  </head>
<body>
<div id="header">
    <div id="h1">
        <h1 class = "centered-heading"><a href="homepage.aspx">East African Mathematical Olympiad</a></h1>
    </div>
    
    <div id="sub">   
        <span class="centered-image"><a href="homepage.aspx"><img src="https://www.imo-official.org/logo/IMOLogo_30px.png" alt="IMO" /></a></span>
	...
	<div id="menu">
        ...
        <a id="ctl00_HyperLink_General" href="general.aspx">About EAMO</a> <!--&bull;
...
<div id="footer">
<b>E-mail:</b> 
<a href="mailto:kirstenrosenkilde@gmail.com">__</a> 
&nbsp; &nbsp;
  <br /> 
<b>Webmaster:</b> 
<a href="mailto:webmaster@imo-official.org">__</a>
&nbsp; &nbsp;
</div>
</body>
</html>
